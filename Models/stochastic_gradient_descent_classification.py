...
def stochastic_gradient_descent_classification(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/stochastic_gradient_descent_classification.joblib') 
    ...
    #print(cm)
    return ["Stochastic Gradient Descent Classifier", "SGDC", accuracyScore, precisionScore, recallScore, f1Score]