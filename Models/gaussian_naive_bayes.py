...
def gaussian_naive_bayes(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/gaussian_naive_bayes.joblib') 
    ...
    #print(cm)
    return ["Gaussian Naive Bayes", "GNB", accuracyScore, precisionScore, recallScore, f1Score]