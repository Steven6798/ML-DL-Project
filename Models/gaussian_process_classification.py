...
def gaussian_process_classification(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/gaussian_process_classification.joblib') 
    ...
    #print(cm)
    return ["Gaussian Process Classifier", "GPC", accuracyScore, precisionScore, recallScore, f1Score]