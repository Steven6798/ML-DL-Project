...
def extra_tree_classification(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/extra_tree_classification.joblib') 
    ...
    #print(cm)
    return ["Extra Tree Classifier", "ETC", accuracyScore, precisionScore, recallScore, f1Score]