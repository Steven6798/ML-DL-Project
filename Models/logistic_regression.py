...
def logistic_regression(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/logistic_regression.joblib') 
    ...
    #print(cm)
    return ["Logistic Regression", "LR", accuracyScore, precisionScore, recallScore, f1Score]