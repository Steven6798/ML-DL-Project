...
def bernoulli_naive_bayes(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/bernoulli_naive_bayes.joblib') 
    ...
    #print(cm)
    return ["Bernoulli Naive Bayes", "BNB", accuracyScore, precisionScore, recallScore, f1Score]