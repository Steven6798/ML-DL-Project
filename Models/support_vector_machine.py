...
def support_vector_machine(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/support_vector_machine.joblib') 
    ...
    #print(cm)
    return ["Support Vector Machine", "SVM", accuracyScore, precisionScore, recallScore, f1Score]