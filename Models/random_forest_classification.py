...
def random_forest_classification(estimator, classification_type):
    ...
    dump(classifier, 'TrainedModels/random_forest_classification.joblib') 
    ...
    #print(cm)
    return ["Random Forest Classifier", "RFC", accuracyScore, precisionScore, recallScore, f1Score]